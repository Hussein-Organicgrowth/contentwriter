...
export default function TextEditor() {
  const initialContent = "<p>Hello, start editing here...</p>";
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="border rounded-lg shadow-sm bg-white" ref={toolbarRef}>
        <MenuBar editor={editor} onSave={saveContent} saveStatus={saveStatus} />
      ...
      <div className="mt-4">
        ...
        <pre className="bg-gray-100 p-4 rounded-lg overflow-x-auto">{html}</pre>
      </div>
