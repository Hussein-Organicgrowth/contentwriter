    ...
    return (
      <div key={websiteId}>
        ...
        >
          ...
          >
            <div
              className={`h-12 w-12 flex items-center justify-center rounded-lg border box-border overflow-clip relative ${
            ...
            >
              ...
              />
              <Globe className="h-8 w-8 fallback-icon hidden absolute text-muted-foreground" />
            </div>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete {website.name} and all its
                              associated content.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
