				...
				<div className="space-y-6 bg-white dark:bg-gray-800/50 rounded-2xl p-8 shadow-lg backdrop-blur-lg">
					...
					{companyInfo.summary && (
						<div className="space-y-2">
							...
							<div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 prose prose-sm dark:prose-invert max-w-none">
								<ReactMarkdown>{companyInfo.summary}</ReactMarkdown>
							</div>
						</div>
					)}
